...
body .elma-main-tab.active:not(.elma-qr-tab){background:#17191d;color:#fff;font-weight:790;box-shadow:0 6px 14px #1113182b}
body .elma-main-tab.active:not(.elma-qr-tab) svg{transform:translateY(-1px)}
...
body .elma-main-tab.elma-qr-tab .elma-qr-icon{position:absolute;left:50%;top:-8px;transform:translateX(-50%);width:54px;height:54px;margin:0;border:0;outline:0;border-radius:13px;background:#111;color:#fff;box-shadow:0 6px 14px #0000001f}
body .elma-main-tab.elma-qr-tab .elma-qr-icon svg{width:31px;height:31px;transform:none}
body .elma-main-tab.elma-qr-tab>span:last-child{position:absolute;left:0;right:0;bottom:0;margin:0;line-height:12px;font-size:10px;text-align:center}
@media(max-width:350px){body .elma-main-tab.elma-qr-tab .elma-qr-icon{top:-6px;width:50px;height:50px;border-radius:12px}body .elma-main-tab.elma-qr-tab .elma-qr-icon svg{width:29px;height:29px}}
