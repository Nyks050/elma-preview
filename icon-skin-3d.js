...
function loadServicePageTheme(){
 ...
 const script=document.createElement('script');script.src='service-page-theme.js?v=20260918-line-icons1';script.defer=true;script.dataset.elmaServiceTheme='1';document.head.appendChild(script);
}
...
function loadScheduleCards(){
 ...
 const sources=[['line-1-ui.js?v=20260918-line-icons1','1'],['line-2-ui.js?v=20260918-line-icons1','2'],['line-6-ui.js?v=20260918-no-sunday-variants1','6']];
