(()=>{
  ...
  function styles(){
    ...
    css.textContent=`
      ...
      @media(max-width:370px){.erm{padding-right:10px;padding-left:10px}.erm-cards{gap:7px}.erm-card-open{padding:8px}.erm-card-head{gap:5px;padding-left:7px}.erm-card-number{width:39px;height:37px;font-size:23px}.erm-card-number small{font-size:8px}.erm-card-title{font-size:11px}.erm-thumb{height:85px}.erm-card-foot{font-size:8px}.erm-card-foot b{font-size:10px}}
