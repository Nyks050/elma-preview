(()=>{
  ...
  function styles(){
    ...
    css.textContent=`
      ...
      .erm-detail-foot{width:100%;margin-top:12px}.erm-dir{display:grid;width:100%;grid-template-columns:1fr 1fr;gap:4px;padding:4px;border:1px solid var(--border);border-radius:13px;background:var(--surface)}.erm-dir button{min-height:28px;border:0;border-radius:8px;background:none;color:var(--muted);font-size:14px!important;font-weight:750!important}.erm-dir button[aria-pressed="true"]{background:var(--ink);color:var(--surface)}.erm-fit{display:grid;place-items:center}.erm-fit svg{width:21px;height:21px;fill:none;stroke:currentColor;stroke-width:1.8;stroke-linecap:round;stroke-linejoin:round}.erm-fit:disabled{opacity:.5}.erm-user-pin{width:17px;height:17px;border:3px solid #fff;border-radius:50%;background:#171719;box-shadow:0 0 0 2px #171719}.erm-location-status{margin:0 0 10px;color:var(--muted);font-size:12px}
