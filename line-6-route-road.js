(()=>{
  ...
  const direction={line:'6',name:'6 Nolu Hat',direction:'Tam güzergâh',stops};
  window.ELMA_LINE_6_ROUTE={stops,directions:[direction]};
  window.ELMA_TRANSIT_LINES=window.ELMA_TRANSIT_LINES||[];
  window.ELMA_TRANSIT_LINES=window.ELMA_TRANSIT_LINES.filter(line=>line.line!=='6').concat(direction);
  let routeMap=null,routeLine=null,routeBounds=null,routeLoading=null,routeMarkers=[];
  ...
  function mount(){
    ...
    card.innerHTML='<button class="eg-route6-head" type="button" aria-expanded="false" aria-controls="egRoute6Body"><span class="eg-route6-icon" aria-hidden="true"><svg viewBox="0 0 32 32"><circle cx="7" cy="24" r="3"/><circle cx="25" cy="8" r="3"/><path d="M9.5 22.5c2.8-6.8 7.7-1.8 10.2-7.5 1.1-2.5 2.5-3.9 3.5-4.7"/></svg></span><span class="eg-route6-copy"><b>6 Nolu Hat</b><small>Tam güzergâh • 45 durak</small></span><span class="eg-route6-toggle" aria-hidden="true"><svg viewBox="0 0 24 24"><path d="m6 9 6 6 6-6"/></svg></span></button><div id="egRoute6Body" class="eg-route6-body" hidden><div id="egRoute6Map" class="eg-route6-map" role="region" aria-label="6 nolu hat tam güzergâh haritası"></div><div class="eg-route6-footer"><span class="eg-route6-legend"><span class="eg-route6-key"></span><span>Tam güzergâh</span></span><span class="eg-route6-legend"><span class="eg-route6-stop-key"></span><span>Gerçek duraklar</span></span><span class="eg-route6-footer-count">45 durak</span></div></div>';
