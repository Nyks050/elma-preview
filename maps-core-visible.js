...
`;
    ...
    function openLegacyTab(name){
      ...
      if(widgets){
        ...
        widgets.style.setProperty('display','block','important');
        widgets.style.setProperty('position','fixed','important');
        widgets.style.setProperty('z-index','840','important');
        widgets.style.setProperty('inset','0','important');
        widgets.style.setProperty('overflow-y','auto','important');
      }
