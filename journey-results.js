(()=>{
  ...
  function makeSheet(origin,destination,drive,walk,transit,preferred){
    ...
    const stopsToggle=$('#jrStopsToggle'),stopsPanel=$('#jrStops');if(stopsToggle&&stopsPanel)stopsToggle.onclick=()=>{stopsPanel.hidden=!stopsPanel.hidden;stopsToggle.classList.toggle('primary',!stopsPanel.hidden)};
